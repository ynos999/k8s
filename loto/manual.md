...
rm /etc/apt/sources.list.d/crio.list
...
===================
test-k8s-master-node-01 10.44.8.61
test-k8s-master-node-02 10.44.8.62
test-k8s-master-node-03 10.44.8.63
test-k8s-worker-node-01 10.44.8.71
test-k8s-worker-node-01 10.44.8.72
...
apt-get update && apt-get install -y cri-o kubelet kubeadm kubectl && systemctl start crio.service
...
kind: ClusterConfiguration
kubernetesVersion: stable
controlPlaneEndpoint: "10.44.8.60:6443"
networking:
...
kind: InitConfiguration
localAPIEndpoint:
  bindAddress: 10.44.8.61  # <-- Change this to the node's actual IP if needed
  bindPort: 6443
nodeRegistration:
  criSocket: "unix:///var/run/crio/crio.sock"
EOF
...
You can now join any number of control-plane nodes running the following command on each as root:
  ...
  kubeadm join 10.44.8.60:6443 --token ryh5pn.r14i09xjxwgxsz3b \
        --discovery-token-ca-cert-hash sha256:f25b7cc2abb9cac9e4a26ea46b9ca6f765d6fc39a65fa4b04f956c1ed5b9cc9d \
        --control-plane --certificate-key 1cde2bcf0cd3854fcb0ffc480898a682a5ce3c74e38d3739a9b4149e80a5d276
